...
if ( ! class_exists('Addon_builder_template_morsels'))
{
	require_once 'addon_builder.php';
}

class Addon_builder_data_template_morsels
{
	/**
	 * local cache array
	 * @var array
	...
	public function __call($method, $args)
	{
		...
		if ( ! in_array($method, $this->aob_non_static_friendly) AND
			 is_callable(array('Addon_builder_template_morsels', $method)))
		{
			return call_user_func_array(array('Addon_builder_template_morsels', $method), $args);
		}
	}
	//end __call
